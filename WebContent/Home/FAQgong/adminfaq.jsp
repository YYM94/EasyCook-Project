...
<link rel="stylesheet" type="text/css" href="../css/adminfaq.css" />
<body>
<%@ include file="../menubar/adminleftbar.jsp"%>
	<div id="faqadmin">
		<div class="search-form">
			...
			<form class="table-form">
				<fieldset>
					...
					<input class="write" type="button" value="FAQ등록" onclick="location.href='/EasyCook_Project/Home/FAQgong/faqwrite.jsp'" />
				</fieldset>
			</form>
		</div>
		...
		<div id="adminfaqcon">
			<div id="con6">회원탈퇴는 어디서 하는건가요?</div>
			<div id="con2">이지쿡</div>
	...
	<div id="admin_page" style="text-align: center;">
		...
		<div id="admin_page_number">
			...
			if (currentPage > 4) {
			%>
				<a href="adminfaq.jsp?page=<%=1%>">[FIRST]</a>
			<%}
			if (currentPage > 1) {
			%>			
				<a href="adminfaq.jsp?page=<%=currentPage-1%>">[PREV]</a>
			<%}
			for (int iCount = startPage; iCount <= endPage; iCount++) {
			%> 
				<a href="adminfaq.jsp?page=<%=iCount%>" >
			...
			if (currentPage < totalPage) {%>
				<a href="adminfaq.jsp?page=<%=currentPage+1%>">[NEXT]</a>
			<%}
			if (endPage < totalPage) {%>
				<a href="adminfaq.jsp?page=<%=totalPage%>">[LAST]</a>
			<%} %>
