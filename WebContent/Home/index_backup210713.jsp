...
<div id="top_menubar">
	...
	<div id="top_search">
		<img id="top_search_icon" src="./images/top_search.png" width="30" height="30"/>
...
<div id="left_menubar">
	<div id="left_menubtn">
		<img src="./images/left_menubtn.png" width="40" height="40"/>
	</div>
	<div id="left_menu">
		<div id="left_menuclosebtn">
			<img src="./images/left_menuclosebtn.png" width="40" height="40"/>
		</div>
		<div id="left_logo">
			<a href="javascript:location.reload()"><img src="./images/logo.png"/></a>
		</div>
		...
		<div id="left_menulink">
			...
			<div id="left_board">
				<a href="./recipeBoard/recipeBoard_view.jsp">레시피 게시판</a>
			</div>
			<div id="left_news">
				<a href="#">핫뉴스</a>
			</div>
